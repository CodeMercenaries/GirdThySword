...
public class DBQueries {
    ...
    public static final String GET_CHAP_REP_ID = "SELECT " + DBConstants.B_KEY_ID + " FROM %s WHERE "
            + DBConstants.B_KEY_BOOK_NAME + " LIKE " + '"' + "%s" + '"' + " AND "
            + DBConstants.B_KEY_CHAP_NUM + "=" + "%d" + " AND " + DBConstants.B_KEY_VERSE_NUM + "=" + 0;
    public static final String GET_TOTAL_CHAPTERS_READ_IN_VERSION = "SELECT " + DBConstants.B_KEY_ID + " FROM %s WHERE "
            + DBConstants.B_KEY_VERSE_NUM + "=" + 0 + " AND "
            + DBConstants.B_KEY_READ + "=" + DBConstants.CODE_READ;
    public static final String GET_TOTAL_CHAPTERS_READ_IN_BOOK = "SELECT " + DBConstants.B_KEY_ID + " FROM %s WHERE "
            + DBConstants.B_KEY_BOOK_NAME + " LIKE " + '"' + "%s" + '"' + " AND "
            + DBConstants.B_KEY_VERSE_NUM + "=" + 0 + " AND "
            + DBConstants.B_KEY_READ + "=" + DBConstants.CODE_READ;
    public static final String GET_CHAP_READ_STATUS = "SELECT " + DBConstants.B_KEY_READ + " FROM %s WHERE "
            + DBConstants.B_KEY_BOOK_NAME + " LIKE " + '"' + "%s" + '"' + " AND "
            + DBConstants.B_KEY_CHAP_NUM + "=" + "%d" + " AND " + DBConstants.B_KEY_VERSE_NUM + "=" + "0";
}
